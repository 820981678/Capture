...
/**
 * <font style="color:red;font-weight:bold;">base on "commons-dbutils-1.5.jar"</font>
 * <p>
...
public class BeanProcessor {
    ...
    /**
     * ResultSet.getObject() returns an Integer object for an INT column. The setter method for the property might take an
     * Integer or a primitive int. This method returns true if the value can be successfully passed into the setter method.
    ...
    /**
     * Factory method that returns a new instance of the given Class. This is called at the start of the bean creation process
     * and may be overridden to provide custom behavior like returning a cached bean instance.
     * 
    ...
    /**
     * The positions in the returned array represent column numbers. The values stored at each position represent the index in
     * the <code>PropertyDescriptor[]</code> for the bean property that matches the column name. If no bean property was found
     * for a column, the position is set to <code>PROPERTY_NOT_FOUND</code>.
     * 
     ...
     * </p>
     * 
     * @param rs The <code>ResultSet</code> currently being processed. It is positioned on a valid row before being passed into
     *            this method.
    ...
    protected Object processColumn(ResultSet rs, int index, Class<?> propType) throws SQLException {
        ...
        else if (propType.equals(Timestamp.class) || propType.equals(Date.class)) {
